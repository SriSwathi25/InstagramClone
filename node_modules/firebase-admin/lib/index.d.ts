...
declare namespace admin.machineLearning {
  ...
  interface ListModelsResult {
    ...
    readonly models: com.example.instagram.Model[];
  ...
  /**
   * A TensorFlow Lite com.example.instagram.Model output object
   */
  ...
  /**
   * A Firebase ML com.example.instagram.Model input object
   */
  ...
  /**
   * A Firebase ML com.example.instagram.Model output object
   */
  interface com.example.instagram.Model {
    /** The ID of the model. */
  ...
  interface MachineLearning {
     ...
     *
     * @return {Promise<com.example.instagram.Model>} A Promise fulfilled with the created model.
     */
    createModel(model: ModelOptions): Promise<com.example.instagram.Model>;
     ...
     *
     * @return {Promise<com.example.instagram.Model>} A Promise fulfilled with the updated model.
     */
    updateModel(modelId: string, model: ModelOptions): Promise<com.example.instagram.Model>;
     ...
     *
     * @return {Promise<com.example.instagram.Model>} A Promise fulfilled with the published model.
     */
    publishModel(modelId: string): Promise<com.example.instagram.Model>;
     ...
     *
     * @return {Promise<com.example.instagram.Model>} A Promise fulfilled with the unpublished model.
     */
    unpublishModel(modelId: string): Promise<com.example.instagram.Model>;
     ...
     *
     * @return {Promise<com.example.instagram.Model>} A Promise fulfilled with the model object.
     */
    getModel(modelId: string): Promise<com.example.instagram.Model>;
